...
import { Image, StyleSheet, PropTypes, Text, View, Linking } from 'react-native';
      ...
      <View style={styles.container}>
        <View style={styles.card}>
          <View style={styles.imgWrap}>
            <Image source={{ uri: item.picture || fallbackImage }} style={styles.img}>
          ...
          <Text style={styles.timestampText}>{time.getTimeAgo(item.created_time)}</Text>
        </View>
      </View>
    );
  }
