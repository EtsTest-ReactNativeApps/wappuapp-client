        ...
        <ScrollView style={styles.container}>
          <View style={styles.content}>
            ...
            <Text style={styles.paragraph}>
              ...
              operated by Futurice Oy ("us", "we", or "our").
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              <Text style={styles.bold}>Accounts</Text>
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              <Text style={styles.bold}>Links To Other Web Sites</Text>
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              ...
              wappu@futurice.com. Postal address: Kelloportinkatu 1 D, 33100 Tampere.
            </Text>
          </View>
        </ScrollView>
      </View>
