    ...
    return (
      <TabBarIOS tintColor={theme.secondary} translucent={true}>
        ...
        <MDIcon.TabBarItemIOS
          ...
          onPress={() => {
            this.onChangeTab(Tabs.CALENDAR);
          }}
        >
        ...
        <MDIcon.TabBarItemIOS
          ...
          title=""
          selected={currentTab === Tabs.MOOD}
          onPress={() => {
            this.onChangeTab(Tabs.MOOD);
          }}
        >
        ...
        <MDIcon.TabBarItemIOS
          ...
          onPress={() => {
            this.onChangeTab(Tabs.SETTINGS);
          }}
        >
